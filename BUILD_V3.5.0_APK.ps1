...
Write-Host "ETF Finance Manager V3.5.0 - Native Monitor + Widget APK" -ForegroundColor Cyan
...
Write-Host "V3.5.0 APK build submitted/completed." -ForegroundColor Green
